...
public interface RecepientRepository extends JpaRepository<Recepient, Integer> {
  ...
  @Query("SELECT new com.sjsu.dto.RecepientDTO(r.custAccountID,  r.firstName, r.lastName, r.zipCode, r.accountNum, r.nickName, r.routingNumber, r.isSameBank) from Recepient r where r.custAccountID =?1")
